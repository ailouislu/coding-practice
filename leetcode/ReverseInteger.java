...
public class ReverseInteger {
    ...
    public static int reverse (int x) {
        ...
        {
            int tail = x % 10;
            // Dividing the value by % gives us remainder back so.
            // We can get the last value

            int newResult = result * 10 + tail;
            // in the newresult adding the tail value
            // which we got because let say we have something like
            //this 123, and from tail we got 3. Now what will happen when we add 2
            // after 3 when we come back we have something like
